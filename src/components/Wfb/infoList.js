...
const tradeInfo = {
    ...
    orderCreateTime: 1539325954000,
    price: 500000,
    companyName: '成都香菇年文化传媒有限公司',
    registerDate: 1530415954000,
    ownerMobile: '13880966893',
    companyCredit: 3,
    companyCouponCreateTime: 1530415954000,
    isUse: '已使用',
    providerName: '环泰知识产权有限公司',
    providerCreateTime: 1530411454000,
    providerRegistPhone: '1388096683',
    providerCredit: 3,
    providerCouponCreateTime: 1530411454000,
    providerStatus: '已兑现',
    couponID: '181025142410441',
    couponCreateTime: 1530411454000,
    auditAdmin: '黄琪',
    statusName: '已审核',
    auditTime: 0,
    delete: true
...
const declareDetailInfo = {
    ...
    companyName:'成都香菇年文化传媒有限公司',
    registerTime: 1530415954,
    registerPhone:'13880966893',
    starLevel: 5,
    creditCardApplyTime:1530411454000,
    creditCardType:'已下载',
    creditCardNo:'18102514241044',
    creditCardGrantTime: 1530411454000,
    applyName:'黄琪',
    auditStatus:'已审核',
    auditTime:1530411454000,
    auditPass:'是'
};
